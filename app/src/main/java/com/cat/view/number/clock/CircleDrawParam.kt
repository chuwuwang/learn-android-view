 ...
 * alpha: 0 ~ 255
 */
data class CircleDrawParam(var line1Angle: Float, var line1Alpha: Int, var line2Angle: Float, var line2Alpha: Int) {
    ...
    fun transition(newParam: CircleDrawParam, progress: Float): CircleDrawParam {
        ...
        val tempLine1Alpha: Int = (line1Alpha + (newParam.line1Alpha - line1Alpha) * progress).toInt()
        val tempLine2Angle: Float = line2Angle + (newParam.line2Angle - line2Angle) * progress
        val tempLine2Alpha: Int = (line2Alpha + (newParam.line2Alpha - line2Alpha) * progress).toInt()
