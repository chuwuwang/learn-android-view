...
class ComponentsManager {
    ...
    private val circleArray = Array(3) {
        return@Array Array(14) { CircleDrawer() }
    }
    ...
    fun initConfigureInfo(context: Context, attrs: AttributeSet?) {
        ...
        aspectRatio = (14 * radius * 2 + circleMargin * 15) * 1.0f / (3 * radius * 2 + circleMargin * 4)
    }
    ...
    private fun initSecondComponents() {
        val arrays1 = arrayOf(circleArray[0][10], circleArray[0][11], circleArray[0][12], circleArray[0][13])
        val arrays2 = arrayOf(circleArray[1][10], circleArray[1][11], circleArray[1][12], circleArray[1][13])
        val arrays3 = arrayOf(circleArray[2][10], circleArray[2][11], circleArray[2][12], circleArray[2][13])
        val arrays = arrayOf(arrays1, arrays2, arrays3)
        secondComponents = TimeComponents(arrays)
    }

    private fun initSplit2Components() {
        val arrays = arrayOf(circleArray[0][9], circleArray[1][9], circleArray[2][9])
        split2Components = SplitLineComponents(arrays)
    }

    private fun initMinuteComponents() {
        val array1 = arrayOf(circleArray[0][5], circleArray[0][6], circleArray[0][7], circleArray[0][8])
        val array2 = arrayOf(circleArray[1][5], circleArray[1][6], circleArray[1][7], circleArray[1][8])
        val array3 = arrayOf(circleArray[2][5], circleArray[2][6], circleArray[2][7], circleArray[2][8])
        val arrays = arrayOf(array1, array2, array3)
        minuteComponents = TimeComponents(arrays)
    }

    private fun initSplit1Components() {
        val arrays = arrayOf(circleArray[0][4], circleArray[1][4], circleArray[2][4])
        split1Components = SplitLineComponents(arrays)
    }

    private fun initHourComponents() {
        val array1 = arrayOf(circleArray[0][0], circleArray[0][1], circleArray[0][2], circleArray[0][3])
        val array2 = arrayOf(circleArray[1][0], circleArray[1][1], circleArray[1][2], circleArray[1][3])
        val array3 = arrayOf(circleArray[2][0], circleArray[2][1], circleArray[2][2], circleArray[2][3])
        val arrays = arrayOf(array1, array2, array3)
        hourComponents = TimeComponents(arrays)
    }
    ...
    private fun dp2px(context: Context, dpValue: Int): Float {
        return TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, dpValue.toFloat(), context.resources.displayMetrics)
    }
