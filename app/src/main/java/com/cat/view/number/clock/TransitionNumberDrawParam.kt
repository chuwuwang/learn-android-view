...
fun AbsNumberDrawParam.transition(newNumber: AbsNumberDrawParam, progress: Float): AbsNumberDrawParam {
    ...
    val arrays = arrayOf(circleDrawParam0, circleDrawParam1, circleDrawParam2, circleDrawParam3, circleDrawParam4, circleDrawParam5)
    return TransitionNumberDrawParam(arrays)
}